package com.xcb.network.okhttp.store;
 ...
 * <p/>
 * <br/>
 * A persistent com.chexiaoya.wukong.common.network.cookie com.chexiaoya.wukong.common.network.store which implements the Apache HttpClient CookieStore interface.
...
public class PersistentCookieStore implements CookieStore {
	...
	/**
	 * Construct a persistent com.chexiaoya.wukong.common.network.cookie com.chexiaoya.wukong.common.network.store.
	 *
	 * @param context Context to attach com.chexiaoya.wukong.common.network.cookie com.chexiaoya.wukong.common.network.store to
	 */
	public PersistentCookieStore(Context context) {
		cookiePrefs = context.getSharedPreferences(COOKIE_PREFS, 0);
		cookies = new HashMap<String, ConcurrentHashMap<String, Cookie>>();

		// Load any previously stored cookies into the com.chexiaoya.wukong.common.network.store
	...
	protected void add(HttpUrl uri, Cookie cookie) {
		...
		// Save com.chexiaoya.wukong.common.network.cookie into persistent com.chexiaoya.wukong.common.network.store
