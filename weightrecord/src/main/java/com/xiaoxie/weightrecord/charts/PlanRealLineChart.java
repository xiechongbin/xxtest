 ...
 */
public class PlanRealLineChart extends LinearLayout implements OnChartGestureListener, OnChartValueSelectedListener {
    ...
    private void initView() {
        ...
        mChart = targetCharts.findViewById(R.id.pr_chart);
        initData();
    }
