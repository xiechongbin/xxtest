...
public class GetWeatherUtils {
    ...
    public static void getAlertWeatherInfo(Location location, StringCallback callback) {
        ...
        body.put("token", Constant.TOKEN_WEATHER_ALERT);
        OkHttpUtils.post().url(Constant.URL_WEATHER_ALERT).headers(getHeader()).params(query).params(body).build().execute(callback);
    }
    ...
    public static void getLimitInfo(Location location, StringCallback callback) {
        ...
        body.put("lat", String.valueOf(location.getLatitude()));
        body.put("lon", String.valueOf(location.getLongitude()));
        body.put("token", Constant.TOKEN_LIMIT);
        OkHttpUtils.post().url(Constant.URL_LIMIT).headers(getHeader()).params(query).params(body).build().execute(callback);
    }
    ...
    public static void get6DaysInfo(Location location, StringCallback callback) {
       /* if (location == null) {
        ...
        body.put("token", Constant.TOKEN_BRIEF_FORECAST_6DAYS);
        OkHttpUtils.post().url(Constant.URL_BRIEF_FORECAST_6DAYS).headers(getHeader()).params(query).params(body).build().execute(callback);
    }
    ...
    public static void getBriefConditionInfo(Location location, StringCallback callback) {
        ...
        body.put("lat", String.valueOf(location.getLatitude()));
        body.put("lon", String.valueOf(location.getLongitude()));
        body.put("token", Constant.TOKEN_BRIEF_CONDITION);
        OkHttpUtils.post().url(Constant.URL_BRIEF_CONDITION).headers(getHeader()).params(query).params(body).build().execute(callback);
    }
    ...
    public static void getAQIInfo(Location location, StringCallback callback) {
        ...
        body.put("lat", String.valueOf(location.getLatitude()));
        body.put("lon", String.valueOf(location.getLongitude()));
        body.put("token", Constant.TOKEN_AQI);
        OkHttpUtils.post().url(Constant.URL_AQI).headers(getHeader()).params(query).params(body).build().execute(callback);
    }
